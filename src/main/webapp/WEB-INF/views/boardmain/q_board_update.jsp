				...
				<tbody>
					...
					<tr>
						...
						<c:choose>
							...
							<div class="pull-right"><input type="button"value="글 목록으로... " class="btn btn-primary" 	onclick="javascript:location.href='q_board'" /></div>	
						</td>
					</tr>
				</tbody>
			</table>
					...
					<c:choose>
						...
						<c:otherwise>
							<tr>
								...
								<th><button type="button" class="btn btn-primary" value="등록" id="cq_btn">등록</button></th>
							</tr>
						</c:otherwise>
					</c:choose>
				</tbody>
