				...
				<tbody>
					<tr>
						...
						<td><input type="text" placeholder="제목을 입력하세요. "
							name="q_title" class="form-control" required/></td>
					</tr>
					<tr>
						<th>작성자:</th>
						<td><input type="text" name="q_name" class="form-control"
					...
					<tr>
						...
						<input type="button"	value="글 목록으로... " class="pull-right btn btn-primary"onclick="javascript:location.href='q_board'" /></td>
					</tr>
				</tbody>
			</table>
		</div>
