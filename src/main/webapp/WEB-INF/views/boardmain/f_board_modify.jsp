				...
				<tbody>
					<tr>
						...
						<td><input type="text" placeholder="제목을 입력하세요. "
							name="f_title" class="form-control" value="${f_board.f_title}" /></td>
					</tr>

					<tr>
						<th>작성자:</th>
						<td><input type="text" placeholder="작성자를 입력하세요. "
							name="f_name" class="form-control" value="${f_board.f_name}"/></td>
					</tr>
					...
					<tr>
						...
						<td colspan="2" class="write"><script type="text/javascript"
								...
								<textarea id="f_content" name="f_content" class="form-controll"
								cols="120" rows="10">${f_board.f_content}</textarea>
						</td>
					</tr>
