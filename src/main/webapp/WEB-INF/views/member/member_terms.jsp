...
<form method="post">
	...
	<div class="page-title">
		<div class="container">
			<div class="col-sm-offset-3" style="text-align:left;">
				<h4>이용약관</h4>
			</div>
			<div class="col-sm-offset-3" style="overflow:scroll; width:600px; height:200px; padding:10px; text-align:left; border: 1px solid gray;">
				<div class="acon">
						<h5>제1조(목적)</h5>
						<p>
				...
				<div class="agree-check-box col-sm-offset-3" style="text-align:left;margin-top:5px;">
					<input type="checkbox" name="agree_checkbox1" id="agree_checkbox1" value="이용약관">
					<label for="agree_checkbox1">위 이용약관에 동의합니다.</label>
				</div>
				<div class="col-sm-offset-3" style="text-align:left;margin-top:15px;">
					<h4>개인정보 취급방침</h4>
				</div>
				<div class="col-sm-offset-3" style="overflow:scroll; width:600px; height:200px; padding:10px; text-align:left; border: 1px solid gray;">
					<h5>개인정보 보호정책</h5>
			...
			<div class="col-sm-offset-4 col-sm-4" style="margin-top:20px;margin-bottom: 80px">
				<button class="btn" type="button" id="signupform" name="signupform">회원가입</button>&nbsp&nbsp&nbsp&nbsp
