...
$(document).ready(function() {
	...
	$(document).on('click',"#ordercancel",function(){
		...
		$('#orderCancelConfirm').on('click',function(){
			var input=$("<input>")
			.attr("name","seq")
			.attr("type","hidden")
			.attr("value",val);
						...
						<c:choose>
			        			...
			        			<c:otherwise>
					        			<tr>
											...
											<td style="text-align:center;vertical-align:middle;"><button id="ordercancel" value="${shippings.seq}" type="button" class="btn btn-default">상품취소</button></td>
										</tr>
					        	</c:otherwise>
			        	</c:choose>
					</c:forEach>
	  ...
	  <div class="modal-dialog modal-sm">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	 <span id="orderCancelModalMsg">주문을 취소하시겠습니까?</span>
	      </div>
